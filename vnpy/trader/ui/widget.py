...
class PositionMonitor(BaseMonitor):
    ...
    headers: dict = {
        ...
        "pnl_unreal": {"display": _("盈亏"), "cell": PnlCell, "update": True},
		"pnl_rate": {"display": _("收益率"), "cell": PnlCell, "update": True},
        "mgn_ratio": {"display": _("保证金率"), "cell": BaseCell, "update": True},
        "liq_px": {"display": _("预估强平价"), "cell": BaseCell, "update": True},
        "lever": {"display": _("杠杆倍数"), "cell": BaseCell, "update": False},
        "gateway_name": {"display": _("接口"), "cell": BaseCell, "update": False},
    }
...
class AccountMonitor(BaseMonitor):
    ...
    headers: dict = {
        "accountid": {"display": _("代码"), "cell": BaseCell, "update": False},
